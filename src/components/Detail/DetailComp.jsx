  ...
  return (
    <div className='flex gap-10 my-10 '>
        ...
        <div className='flex items-center gap-5 my-4'>
            ...
            <input className='w-11 text-center text-4xl' type="text" value={quantity} />
            <div onClick={increment} className='text-4xl cursor-pointer'>+</div>
        </div>
        <div onClick={addBasket} className='my-4 border w-[200px] text-xl bg-gray-200 cursor-pointer rounded-md h-16 flex items-center justify-center'>Sepete Ekle</div>
        </div>
    </div>
  )
}
